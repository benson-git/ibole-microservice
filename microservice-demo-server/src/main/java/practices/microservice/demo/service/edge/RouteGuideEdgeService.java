...
*/
@Component
public class RouteGuideEdgeService extends RouteGuideGrpc.AbstractRouteGuide {
 
 private static final Logger logger = Logger.getLogger(RouteGuideEdgeService.class.getName());
