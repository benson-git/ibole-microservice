...
public class ClientInterceptors {
  ...
  private static final ClientCall<Object, Object> NOOP_CALL = new ClientCall<Object, Object>() {
    ...
    /**
     * Always returns {@code false}, since this is only used when the startup of the
     * {@link ClientCall} fails (i.e. the {@link ClientCall} is closed).
     */
    @Override
   ...
   *
   * <p>
   * {@link ClientCall#start(ClientCall.Listener, Metadata)} should not throw any exception other
   * than those caused by misuse, e.g., {@link IllegalStateException}.
   * {@code CheckedForwardingClientCall} provides {@code checkedStart()} in which throwing
   * exceptions is allowed.
   */
  public abstract static class CheckedForwardingClientCall<ReqT, RespT> extends
     ...
     *
     * <p>
     * Implementation should call {@code this.delegate().start()} in the normal path. Exceptions may
     * safely be thrown prior to calling {@code this.delegate().start()}. Such exceptions will be
