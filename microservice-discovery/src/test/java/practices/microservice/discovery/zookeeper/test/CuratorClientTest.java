package practices.microservice.discovery.zookeeper.test;
...
public class CuratorClientTest {
	...
	public static void main(String[] args) throws Exception {
    	...
    	ServerIdentifier identifier = new ServerIdentifier(ServerIdentifier.ServiceType.RPC, list);
		// 1.Connect to zk
		CuratorFramework client = CuratorFrameworkFactory.newClient(identifier.getConnectionString(), new RetryNTimes(10, 5000));
		client.start();
