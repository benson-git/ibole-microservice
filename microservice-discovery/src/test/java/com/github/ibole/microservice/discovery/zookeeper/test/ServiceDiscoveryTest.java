...
public class ServiceDiscoveryTest {
  ...
  @Test
  public void testServieDiscoveryProvider() {
    ServerIdentifier serverIdentifier = new ServerIdentifier("/root", Lists.newArrayList());
    ServiceDiscovery<HostMetadata> serviceDiscovery = ServiceDiscoveryProvider.provider().getDiscoveryFactory().getServiceDiscovery(serverIdentifier);
    org.junit.Assert.assertEquals("/root", serviceDiscovery.getIdentifier().getRootPath().getPath());
  }
