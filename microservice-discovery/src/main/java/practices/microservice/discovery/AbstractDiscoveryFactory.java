...
public abstract class AbstractDiscoveryFactory implements DiscoveryFactory<ServiceDiscovery<InstanceMetadata>> {

	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractDiscoveryFactory.class);
    private static final Map<ServerIdentifier, ServiceDiscovery<InstanceMetadata>> REPOSITION = Maps.newConcurrentMap();
    ...
    protected abstract ServiceDiscovery<InstanceMetadata> createDiscovery(ServerIdentifier identifier);
}
