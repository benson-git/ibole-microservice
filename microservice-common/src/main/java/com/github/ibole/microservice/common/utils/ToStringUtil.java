...
/**
 * This class consists exclusively of static methods to help in {@link Object#toString()} method
 * overriding.
 * 
 * <p>Pattern:
 * 
...
public final class ToStringUtil {
   ...
   * 
   * <p>The returned buffer is created with a default capacity of {@code 128}.
   * 
  ...
  /**
   * Creates and return a new {@code StringBuilder} with the given {@code
   * capacity}, and {@code field} and {@code value} appended after the opening brace.
   * 
   ...
   */
  public static StringBuilder start(final int capacity, final String field, final Object value) {
   ...
   * 
   * @param buffer the buffer to append {@code field} and {@code value} to
   * @param field the name of the field
   * @param value the value of the field
   * @return the buffer itself
   * @throws NullPointerException if {@code buffer} is {@code null}
   */
  public static StringBuilder append(final StringBuilder buffer, final String field,
      final Object value) {
    buffer.append(',');
    buffer.append(' ');
    makeKeyValue(buffer, field, value);
  ...
  /**
   * Appends the given {@code field} and {@code value} to {@code buffer}. The {@code char} value is
   * converted to a {@code String} before the method invokes and returns from
   * {@link #append(StringBuilder, String, Object)}.
   * 
   * @param buffer the buffer to append {@code field} and {@code value} to
   * @param field the name of the field
   * @param value the {@code char} value of the field
   * @return the buffer itself
   * @throws NullPointerException if {@code buffer} is {@code null}
   */
  public static StringBuilder append(final StringBuilder buffer, final String field,
  ...
  private static void makeKeyValue(final StringBuilder buffer, final String field,
      final Object value) {
    buffer.append(field);
    buffer.append('=');
    buffer.append(value);
